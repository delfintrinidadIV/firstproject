...
function cyberchimps_add_core_fields( $fields_list ) {
	...
	if ( $theme_check == 'free' ):
		...
		$fields_list[] = array(
			'name'    => __( 'Slider Image 4', 'cyberchimps_core' ),
			'desc'    => __( 'Enter URL or upload file', 'cyberchimps_core' ),
			'id'      => 'image_four_slide',
			'type'    => 'upload',
			'std'     => $directory_uri . apply_filters( 'cyberchimps_slider_lite_img4', '/elements/lib/images/slider/slide1.jpg' ),
			'section' => 'cyberchimps_blog_slider_lite_section',
			'heading' => 'cyberchimps_blog_heading'
		);

		$fields_list[] = array(
			'name'    => __( 'Slide 4 URL', 'cyberchimps_core' ),
			'id'      => 'image_four_slide_url',
			'std'     => apply_filters( 'cyberchimps_slider_lite_url4', 'http://cyberchimps.com' ),
			'type'    => 'text',
			'section' => 'cyberchimps_blog_slider_lite_section',
			'heading' => 'cyberchimps_blog_heading'
		);
