...
function cyberchimps_slider_lite_page_options() {
	...
	array(
            'type'  => 'single_image',
            'id'    => 'cyberchimps_slider_lite_slide_four_image',
            'class' => '',
            'name'  => __( 'Slide Four Image', 'cyberchimps_elements' ),
            'std'   => $directory . apply_filters( 'cyberchimps_slider_lite_img4', '/elements/lib/images/slider/slide1.jpg' )
        ),
        array(
            'type'  => 'text',
            'id'    => 'cyberchimps_slider_lite_slide_four_url',
            'class' => '',
            'name'  => __( 'Slide Four Link', 'cyberchimps_elements' ),
            'std'   => 'http://cyberchimps.com'
        )
...
function cyberchimps_slider_lite_content() {
	...
	if( is_page() ) {
		...
		$slides[3]['link'] = get_post_meta( $post->ID, 'cyberchimps_slider_lite_four_three_url', true );
	}
		...
		$slides[3]['link'] = cyberchimps_get_option( 'image_four _slide_url', apply_filters( 'cyberchimps_slider_lite_url4', 'http://cyberchimps.com' ) );
